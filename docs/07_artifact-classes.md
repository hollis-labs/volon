...
| **PCC** | Compressed, truth-checked agent context — reduces repeated repo scanning | Agents only | `.volon/pcc/` |
| **Bootstrap** | Execution handoff — iteration boundary, what to do next | Humans + Agents | `.volon/bootstrap.md` |
