# Forge Feature Alignment to System Invariants

This document maps existing Forge concepts to the system invariants they uphold.
...
- Forge correctly treats tools as first-class and guarded.
...
Agent Envelopes are Forge’s execution boundary for agentic behavior.
...
Forge is internally consistent with its invariants.
