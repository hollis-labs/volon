...
- `.volon/bootstrap.md` (current)
- `.volon/bootstrap/history/bootstrap-iteration-<N>.md` (optional)
...
1. Read `.volon/bootstrap.md` if present (optional; provides next action).
2. Drive execution from `.volon/tasks/`.
