# Forge System Invariants

## Purpose

Forge is a **harness for AI-assisted work**.
...
Forge is intentionally *not* a fully autonomous agent runtime.

---

## Hard Invariants (Enforced by Forge)

These rules are **non-negotiable**.  
Features that violate them are misaligned with Forge.

---

### 1. Execution Control Belongs to the Harness

- Forge owns the orchestration loop.
- Models do not decide what happens next.
- Tool execution is always mediated by Forge.

**Rule:**  
Models may propose actions; Forge disposes.
...
**Rule:**  
Forge favors explainability over cleverness.
...
Forge supports multiple delegation modes **by choice**:
...
> Forge is not an agent.  
> Forge is the system that agents operate inside.
