...
Run: !`find . -name "*.md" -not -path "./.git/*" -not -path "./.forge/logs/*" 2>/dev/null || true`
...
Run: !`find .forge/tasks/ -name "TASK-*.md" 2>/dev/null || true`
...
Run: !`find .forge/pcc/ -name "*.md" 2>/dev/null || true`
