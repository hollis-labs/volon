...
Read `forge.yaml` (or `.forge/forge.yaml`), `.forge/pcc/00_project.md`, and `.forge/pcc/01_architecture.md` for context.
...
- Config inspected: forge.yaml, pcc/00_project.md, pcc/01_architecture.md
```
