...
Read `.forge/agent-boot.md` to understand what the core boot pack already provides.
...
## Provided by core boot (.forge/agent-boot.md)
<Items already covered — do not duplicate>
- Ground truth paths (forge.yaml, bootstrap, PCC, tasks, logs)
...
## Role addendum
Does this agent need a new entry in `.forge/boot/`?
