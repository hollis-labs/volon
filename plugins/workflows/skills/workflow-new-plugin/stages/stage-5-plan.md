...
| Path | Change |
|---|---|
| volon.yaml | Add plugin enable flags (if applicable) |
| .volon/pcc/01_architecture.md | Add plugin to architecture summary |
...
- [ ] volon.yaml references plugin (if applicable)
